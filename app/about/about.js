   ...
   <main className='flex flex-row w-[100vw] h-[80vh] '>
    <div id='details' className=' w-[70vw] h-[80vh]'>
      <main className='grid grid-cols-2 gap-10 m-8 mt-28'>
            ...
            <img className='w-12 h-16 mt-5' src="https://img.icons8.com/ios-filled/50/source-code.png" alt="source-code"/>
               </div>
            ...
            <img className='w-16 h-24 -ml-2 mt-2'
            ...
            <div id='image' className=' basis-1/3 -mr-10 ml-5'><img className='w-12 h-16 '
            ...
            <div id='image' className=' basis-1/3 -mr-4'><img className='w-12 h-16' src="https://img.icons8.com/ios-filled/50/virtual-machine.png" alt="virtual-machine"/> </div>
            ...
            <div className="container  border rounded  h-32 pt-5 flex flex-row gap-2" id='soft skill'>
              <div id='image' className=' basis-1/3 ml-5 -mr-10'>
              <img className='w-12 h-16' src="https://img.icons8.com/ios-filled/50/communication-skill.png" alt="communication-skill"/> </div>
            ...
            <div id='image' className=' basis-1/3 -mr-4'>
              <img className='w-12 h-16' src="https://img.icons8.com/ios/50/briefcase-settings.png" alt="briefcase-settings"/> </div>
    ...
    <div id="image" className=' basis-1/3 '>
      <img src="/profile2.JPG" className='rounded-full w-[50vw] h-[65vh] p-10 mt-16'/>
    </div>
   </main>
