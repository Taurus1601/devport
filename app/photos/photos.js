...
function Photos() {
 ...
 function handlechangesleave(){
  ...
  return (
   ...
   <h1 className=" font-mono font-semibold text-4xl relative top-0 bg-white h-[15vh] pt-10 px-10 pb-10 w-[100vw]">Photos</h1>

      <main className="flex flex-rows w-[100vw] h-[100vh] translate-y-20 mt-10 overflow-x-hidden">
        <div className="basis-1/2">
          <div > <img src="/IMG_0371.jpeg" alt="" className="w-[100%] " /></div>
          <div className=" h-[66vh]"></div>
          <div >  <img src="/IMG_0922.jpeg"  className="w-[100%]" alt="" /></div>
...
Click Here
        ...
        <div > <img src="/IMG_0918.jpeg" className="w-[100%]" alt="" /></div>
        ...
        <span className='flex relative  '>
            ...
            <img src="/small/2.jpeg" className={`relative  rounded-md translate-x-[248px] -translate-y-12 rotate-0 z-10 ${effect} duration-500`}/>
            ...
            <img src="/small/5.jpeg" className={`absolute  rounded-md translate-x-16 translate-y-0 rotate- z-50 scale-[.5] hover:rotate-3 duration-500`}/>
            <img src="/small/3.jpeg" className={`absolute rounded-md -translate-x-20 -translate-y-5 rotate-45 z-10 ${effect1} duration-500`}/>
            <img src="/small/4.jpeg" className={`absolute rounded-md translate-x-56 -translate-y-5 rotate-12 z-10 ${effect1} duration-500`}/>
          </span>
